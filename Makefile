...
simulation: $(SRCDIR)simulation.cpp   generator.o job.o dps-runner.o  fcfs-runner.o ps-runner.o server.o  
	$(CC) $(FLAGS) -o $(BINDIR)$@ $< $(BUILDDIR)generator.o $(BUILDDIR)job.o $(BUILDDIR)fcfs-runner.o $(BUILDDIR)ps-runner.o $(BUILDDIR)dps-runner.o   $(BUILDDIR)server.o  
